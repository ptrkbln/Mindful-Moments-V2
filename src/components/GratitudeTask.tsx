...
const textAreaStyle =
  "w-[300px] sm:w-[600px] text-[#222] font-['Playpen_Sans',cursive] font-extralight text-[18px] sm:text-[24px] resize-none leading-[40px] pl-[100px] sm:pr-1 pt-[7px] pb-[34px] rounded-[12px] shadow-[0px_2px_14px_#000] border-y border-white m-8 [background-image:url('./assets/images/lines_text_area.png'),url('./assets/images/paper_text_area.png')] [background-repeat:repeat-y,repeat]";
